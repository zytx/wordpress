...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(B).y(1(){$("6.7-5").4().f("<d></d>");$("6.5 J d").t(1(){$(2).4().j("6.7-5").s("u").v();$(2).4().l(1(){},1(){$(2).4().j("6.7-5").w("r")})}).l(1(){$(2).K("q")},1(){$(2).G("q")});F($("#8 .c .b .9 .3 p .e").H==0){$("I").x();$("m").f("<p><a E=\'D\'n=\\"k://g.h.o.i\\">请勿删除版权信息！务必保留页脚z类.3，方可显示正常。</a></p>")}$("#8 .c .b .9 .3 p .e").m("技术支持：A主题公园");$("#8 .c .b .9 .3 p .e").C("n","k://g.h.o.i")});',47,47,'|function|this|f_bq|parent|menu|ul|sub|footer|c3||ym3_2|ym3|span|banquan|append|www|themepark|cn|find|http|hover|html|href|com||subhover|slow|slideDown|mouseover|fast|show|slideUp|remove|ready|css|WEB|document|attr|_blank|target|if|removeClass|length|body|li|addClass'.split('|'),0,{}))
